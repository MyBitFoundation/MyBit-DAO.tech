...
contract AssetToken is Controlled {
    ...
    AssetTokenFactory public tokenFactory;

////////////////
// Constructor
////////////////

    /// @notice Constructor to create a AssetToken
    /// @param _tokenFactory The address of the AssetTokenFactory contract that
    ...
    constructor(
        AssetTokenFactory _tokenFactory,
        AssetToken _parentToken,
...
////////////////
    ...
    /// @return The address of the new AssetToken Contract
    function createCloneToken(
        ...
        bool _transfersEnabled,
        address _erc20Address
    ) public returns(AssetToken)
    {
        uint256 snapshot = _snapshotBlock == 0 ? block.number.sub(1) : _snapshotBlock;

        AssetToken cloneToken = tokenFactory.createCloneToken(
            this,
            snapshot,
            _cloneTokenName,
            _cloneDecimalUnits,
